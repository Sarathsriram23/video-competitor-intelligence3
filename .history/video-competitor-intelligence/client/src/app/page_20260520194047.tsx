      ...
      <main className="flex-1 flex flex-col items-center justify-start p-6 md:p-12 max-w-7xl mx-auto w-full">
        ...
        {report && !loading && (
          <div className="w-full flex flex-col space-y-8 py-4 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 border border-white/10 rounded-2xl p-6 relative overflow-hidden">
              ...
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <span className={`text-[10px] uppercase font-bold tracking-wider px-3 py-1 rounded-full ${report.id.includes('demo') ? 'bg-yellow-500/20 text-yellow-300 border border-yellow-500/30' : 'bg-indigo-500/20 text-indigo-300 border border-indigo-400/30'}`}>
                ...
                <div className="h-64 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      />
                      <Tooltip 
                        contentStyle={{ backgroundColor: '#1a1f3a', border: '2px solid rgba(99,102,241,0.4)', borderRadius: '8px', padding: '8px 12px', boxShadow: '0 4px 12px rgba(0,0,0,0.4)' }} 
                        labelStyle={{ fontWeight: 'bold', color: '#e0e7ff', marginBottom: '4px' }}
                        formatter={(value: any) => [parseInt(value).toLocaleString(), 'Subscribers']}
                        contentItemStyle={{ color: '#c7d2fe', fontSize: '12px', fontWeight: '500' }}
                      />
                ...
                <div className="h-64 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Tooltip 
                        contentStyle={{ backgroundColor: '#1a1f3a', border: '2px solid rgba(168,85,247,0.4)', borderRadius: '8px', padding: '8px 12px', boxShadow: '0 4px 12px rgba(0,0,0,0.4)' }}
                        labelStyle={{ fontWeight: 'bold', color: '#e9d5ff', marginBottom: '4px' }}
                        ...
                        contentItemStyle={{ color: '#d8b4fe', fontSize: '12px', fontWeight: '500' }}
                      />
                  ...
                  <div className="h-48 w-full mt-4">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={report.analysis}>
                        <XAxis dataKey="companyName" stroke="#94a3b8" fontSize={9} tickLine={false} />
                        <YAxis stroke="#94a3b8" fontSize={9} tickLine={false} tickFormatter={(v) => `${v}%`} />
                        <Tooltip 
                          contentStyle={{ backgroundColor: '#1a1f3a', border: '2px solid rgba(34,197,94,0.4)', borderRadius: '8px', padding: '8px 12px', boxShadow: '0 4px 12px rgba(0,0,0,0.4)' }}
                          labelStyle={{ fontWeight: 'bold', color: '#dcfce7', marginBottom: '4px' }}
                          formatter={(v: any) => [`${parseFloat(v).toFixed(2)}%`, 'Engagement']}
                          contentItemStyle={{ color: '#bbf7d0', fontSize: '12px', fontWeight: '500' }}
                        />
