      ...
      <main className="flex-1 flex flex-col items-center justify-start p-6 md:p-12 max-w-7xl mx-auto w-full">
        ...
        {report && !loading && (
          <div className="w-full flex flex-col space-y-8 py-4 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 bg-[#0a0f1d] border border-white/5 rounded-2xl p-6 relative overflow-hidden">
              ...
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <span className={`text-[10px] uppercase font-bold tracking-wider px-2.5 py-0.5 rounded-full ${report.id.includes('demo') ? 'bg-yellow-500/10 text-yellow-400 border border-yellow-500/20' : 'bg-indigo-500/10 text-indigo-400 border border-indigo-400/20'}`}>
            ...
            {/* SECTION 0: CONTENT PERFORMANCE - VIDEOS GRID */}
            <div className="w-full space-y-4">
              <div className="flex items-center gap-2 text-indigo-400">
                <FileVideo className="w-5 h-5" />
                <span className="text-xs font-bold uppercase tracking-wider font-mono">Content Performance</span>
              </div>
            ...
            {/* SECTION 6: ROADMAP & 90-DAY KEY STEPS */}
