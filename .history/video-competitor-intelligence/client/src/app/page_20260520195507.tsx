      ...
      <nav className="border-b border-white/5 py-4 px-6 md:px-12 flex justify-between items-center bg-[#020617]/50 backdrop-blur-md sticky top-0 z-40">
        ...
        <div className="flex items-center gap-4">
          <button 
            ...
            className="flex items-center gap-2 text-xs bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-300 px-3 py-1.5 rounded-lg transition-colors font-mono"
          >
              ...
              <form onSubmit={handleGenerateReport} className="space-y-6 relative z-10">
                ...
                <div className="pt-4 flex flex-col sm:flex-row gap-4">
                  ...
                  <button
                    ...
                    className="bg-slate-100 hover:bg-slate-200 text-blue-700 hover:text-blue-800 border border-slate-300 rounded-xl px-5 py-3.5 transition-all flex items-center justify-center gap-2 font-medium"
                  >
          ...
          <div className="w-full flex flex-col space-y-8 py-4 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 bg-gradient-to-r from-white via-blue-50 to-white border border-slate-200 rounded-2xl p-6 relative overflow-hidden shadow-sm">
              ...
              <div className="flex items-center gap-3 shrink-0">
                ...
                <button
                  onClick={handleReset}
                  className="bg-slate-100 hover:bg-slate-200 border border-slate-300 text-slate-700 font-semibold text-sm rounded-xl px-4 py-2.5 flex items-center gap-2 transition-all"
                >
                          ...
                          return (
                            <tr key={a.companyName} className={`hover:bg-white/5 transition-colors ${a.isMainCompany ? 'bg-indigo-500/5' : ''}`}>
                              ...
                              <td className="py-3 text-center">
                                <span className="bg-blue-100 text-[10px] px-2 py-0.5 rounded font-mono text-blue-800 font-semibold">
                                  {topVideo.category}
                                </span>
                              </td>
                            </tr>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 glass-card p-6 rounded-2xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Competitor Strategy Blind Spots</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-4 rounded-xl border border-blue-200 space-y-3">
                      <span className="text-[10px] uppercase font-bold tracking-wider text-emerald-700 font-mono block">Untapped Keywords</span>
                      <p className="text-[11px] text-slate-700">Competitors cover these themes, but they are missing from your recent titles:</p>
                      
                      <div className="space-y-2">
                        {report.gapAnalysis.untappedTopics.map((topic) => (
                          <div key={topic} className="flex items-center gap-2 bg-emerald-100 border border-emerald-300 px-2.5 py-1.5 rounded-lg">
                            <CheckCircle className="w-3.5 h-3.5 text-emerald-700 shrink-0" />
                            <span className="text-xs font-bold text-emerald-800">Target query sector: "{topic}"</span>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-4 rounded-xl border border-purple-200 space-y-3">
                      <span className="text-[10px] uppercase font-bold tracking-wider text-purple-700 font-mono block">Underutilized Formats</span>
                      <p className="text-[11px] text-slate-700">Formats utilized in the wider market but underrepresented (&lt;5% share) on your channel:</p>
                      
                      <div className="space-y-2">
                        {report.gapAnalysis.underutilizedFormats.map((fmt) => (
                          <div key={fmt} className="flex items-center gap-2 bg-purple-100 border border-purple-300 px-2.5 py-1.5 rounded-lg">
                            <Sparkles className="w-3.5 h-3.5 text-purple-700 shrink-0" />
                            <span className="text-xs font-bold text-purple-800">Expand format category: {fmt}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                ...
                <div className="text-[10px] text-slate-600 italic mt-6 pt-3 border-t border-slate-200">
